                                    ...
                                    <tr>
                                        ...
                                        <td><!-- Button trigger modal -->
                                            ...
                                            <form action="{{ route('category.destroy',$item->id) }}" method="POST" style="display:inline";>
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-danger btn-sm " onclick="return confirm('Are you sure that you want to Delete This Record?')">Delete</button>
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('category.store') }}">
                            ...
                            <button type="submit" class="btn btn-primary float-end">Enter</button>
                        </form>
                    </div>
                </div>
            </div>
